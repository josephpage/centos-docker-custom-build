install
url --url=http://mirror.ovh.net/ftp.centos.org/6/os/x86_64/
lang en_US.UTF-8
keyboard fr
...
repo --name="CentOS" --baseurl=http://mirror.ovh.net/ftp.centos.org/6/os/x86_64/ --cost=100
repo --name="Updates" --baseurl=http://mirror.ovh.net/ftp.centos.org/6/updates/x86_64/ --cost=100
...
repo --name="CentOSPlus" --baseurl=http://mirror.ovh.net/ftp.centos.org/6/centosplus/x86_64/ --cost=1000
